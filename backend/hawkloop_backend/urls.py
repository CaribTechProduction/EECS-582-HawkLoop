...
from hawkloop_backend.hawkloop_app.views import RouteViewSet, StopViewSet, VehicleViewSet, AlertViewSet
...
urlpatterns = [
    path('', home, name='home'),  # New home page at '/'
    ...
    path('api/', include('hawkloop_backend.hawkloop_app.urls')),
    path('api/', include('favorites.urls')),  # Add the favorites endpoints
    path('api-auth/', include('rest_framework.urls')), #This line enables login
]
