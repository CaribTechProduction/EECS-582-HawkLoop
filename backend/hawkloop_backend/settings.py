"""
Django settings for hawkloop_backend project.
...
env_path = Path(__file__).resolve().parent / "db.env"
...
SECRET_KEY = 'django-insecure-jr6b57k5+68+s6l#5me$4)((&qr!m0tx0%3n85+8=!w)ubd**&'
...
ROOT_URLCONF = 'hawkloop_backend.urls'
